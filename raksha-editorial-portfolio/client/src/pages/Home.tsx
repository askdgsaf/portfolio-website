...
const projects: Project[] = [
  { name: "TODOAPP", description: "A task manager built with TypeScript", year: "2025", tag: "app", repo: "todoapp", tone: "linen", image: "/manus-storage/todoapp-preview_0eca664d.png" },
  { name: "SOULFUEL BITES", description: "A multi-page site for a food brand", year: "2025", tag: "web", repo: "soulfuel-bites", tone: "peach" },
  { name: "GREENERY", description: "An eco-travel journal for mindful adventures", year: "2025", tag: "web", repo: "greenery", tone: "sage", image: "/manus-storage/greenery-ecotrails_77c99da4.webp" },
  { name: "PRODUCT CART LIST", description: "Interactive cart with live totals in JS", year: "2024", tag: "js", repo: "product-cart-list", tone: "stone" },
  { name: "FAQ ACCORDION", description: "Accessible expand/collapse component", year: "2024", tag: "component", repo: "faq-accordion", tone: "clay" },
  { name: "RECIPE PAGE", description: "Responsive layout from a design brief", year: "2024", tag: "layout", repo: "recipe-page", tone: "cream" },
];
  ...
  return (
    <section className="hero container" id="top" aria-labelledby="hero-title">
      <Reveal className="hero-intro">
        ...
        <h1 id="hero-title" className="display display-hero">A WEB<br /><em>&amp; Frontend</em><br />DEVELOPER</h1>
        <p className="hero-copy">Building clean, responsive interfaces with HTML, CSS and JavaScript — and levelling up with Node.js. I like problems that need untangling, whether that's a layout bug or a puzzle.</p>
      ...
      <Reveal className="portrait-wrap" delay={90}>
        <div className="portrait-placeholder has-image"><img className="portrait-image" src="/manus-storage/raksha-portrait_dbb2fefb.png" alt="Illustrated portrait of Rakshya Pathak" /></div>
...
function ProjectCard({ project, index }: { project: Project; index: number }) {
  return <>
    <a className="project-card" href={`https://github.com/askdgsaf/${project.repo}`} target="_blank" rel="noreferrer">
      <div className={`project-image ${project.tone} ${project.image ? "has-image" : ""}`}>
